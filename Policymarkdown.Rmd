...
ggplot() +
  geom_line(data = data, aes(x = Date, y = value), color = "red") +
  geom_line(data = retail_data, aes(x = Date, y = Avg_fixed/15), color = "blue") +
  scale_y_continuous(sec.axis = sec_axis(~.*15, name= "energy prices")) +
  facet_wrap(~Type)
```
...
ggplot() +
  geom_line(data = data, aes(x = Date, y = value), color = "red") +
  geom_line(data = retail_data, aes(x = Date, y = Default/15), color = "blue") +
  scale_y_continuous(sec.axis = sec_axis(~.*15, name= "energy prices")) +
  facet_wrap(~Type)
```
...
* Only includes 100 major retailors - may create bias
...
* the dataset only contains the average, and by grouping all tarrifs together it could be removing inequalities, for example regional/socio-economic disparities between energy tarrifs and spending.
